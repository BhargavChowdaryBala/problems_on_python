...
public class DetailsOfStudentsHighestMarks {
        ...
        for (String branch : studentsByBranch.keySet()) {
            ...
            for (Student student : students) {
                ...
                if (highestStudent == null ||
                    student.marks > highestStudent.marks) {

                    highestStudent = student;
                    highestStudentBranch = branch;
                }
            }
        }

        System.out.println("Student with highest marks among all departments:");

        System.out.println("Branch = " + highestStudentBranch);
